<xsl:stylesheet version="3.0"
  ...
  <xsl:variable name="doc-ref" select="'socks_io.ref'"/>
  <xsl:variable name="doc-ns" select="'boost::socks_io'"/>
  ...
  <xsl:template mode="convenience-header" match="@file[contains(., 'boost/socks_io')]">socks_io.hpp</xsl:template>
